...
SEXP r_rwimpute(SEXP r_matrix, SEXP r_p_matrix, SEXP r_col_types, SEXP r_parameters, SEXP r_seed){
    ...
    run_rw_algorithm(data, p_matrix, col_types, params, rows, cols, result, base_seed);
